...
<input type='button' style="width:200px" class="btn btn-primary" value='Add Shipping' onclick="mage.setUrl('<?php echo $this->getUrl()->geturl('form', null, null, true); ?>').load()">
<br><br>
...
<table style="border: 1px solid black; border-collapse:collapse; text-align: center;">
    ...
    <?php else: ?>
        <?php foreach($shipping->getData() as $value): ?>
